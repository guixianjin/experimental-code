""" mainly borrow from: https://github.com/junyuseu/pytorch-cifar-models/blob/master/models/resnet_cifar.py, 
    part of the file has been changed 
"""
...
class ResNet_Cifar(nn.Module):
    ...
    def __init__(self, block, layers, one_channel_picture=False, num_classes=10):
        super(ResNet_Cifar, self).__init__()
        self.inplanes = 16
        self.conv1 = nn.Conv2d(3, 16, kernel_size=3, stride=1, padding=1, bias=False)
        
        if one_channel_picture == True: # change for grey FashionMNIST
...
#        self.fc = nn.Linear(64*block.expansion, num_classes)
        ...
        """ The change of structure of PreAct-ResNet in here: [16,32,64] -> [32,64,128] 
        following "CVPR-18 Joint Optimization Framework for Learning With Noisy Labels " Supplementary Material Table 1 http://openaccess.thecvf.com/content_cvpr_2018/Supplemental/3107-supp.pdf
        """
