...
def get_cifar10_select_ind(all_data_information, transform_train=None, transform_val=None,
                           download=True):

    root = "./data"
    train_labeled_idxs, weight_list, train_unlabeled_idxs, val_idxs, noise_label_50000 = all_data_information

    train_labeled_dataset = CIFAR10_labeled_noise_label(root, noise_label_50000, train_labeled_idxs, train=True, transform=transform_train)
...
class CIFAR10_labeled_noise_label(torchvision.datasets.CIFAR10):

    def __init__(self, root, noise_labels, indexs=None, train=True,
                 transform=None, target_transform=None,
                 download=False):

        super(CIFAR10_labeled_noise_label, self).__init__(root, train=train,
                 transform=transform, target_transform=target_transform,
                 download=download)
        self.train = train
